    ...
    <header className='d-flex justify-between align-center p-40'>
      <Link to='/'>
        <div className='d-flex align-center'>
          ...
          <div>
            <h3 className='text-uppercase m-5'>React sneakers</h3>
            <p className='opacity-5 m-5'>Лучший магазин кросовок</p>
          </div>
        </div>
      </Link>
      <ul className='d-flex '>
        <li onClick={props.onClickCart} className='mr-30 cu-p'>
          <img src='/img/123.svg' alt='card icon' />

          <span className='ml-10 t-10'>{totalPrice} рублей.</span>
        </li>
        <li className='mr-30 cu-p'>
          <Link to='/favorites'>
            <img src='./img/favorites.svg' alt='qwe' />{' '}
          </Link>
        </li>
        <Link to='/orders'>
          <li className='mr-30 cu-p'>
